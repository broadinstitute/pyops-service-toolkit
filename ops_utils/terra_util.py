...
class TerraWorkspace:
    ...
    def get_workflow_status(
            ...
            submission_id: str,
            workflow_id: str,
            expand_workflow_metadata: bool = False) -> requests.Response:
        """
        ...
        **Args:**
        ...
        - expand_workflow_metadata (bool, optional): Whether to expand the workflow metadata.
          Defaults to `False`.

        **Returns:**
        - requests.Response: The response from the request.
        """
        expand_metadata = '?expandSubWorkflows=true' if expand_workflow_metadata else ''
