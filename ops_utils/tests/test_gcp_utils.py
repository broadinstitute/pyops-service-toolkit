...
class TestGCPUtils:
    ...
    def test_copy_file(self):
        ...
        self.gcp_client.copy_cloud_file()
        pass

    @responses.activate
    def test_delete_file(self):
        responses._add_from_file(file_path="ops_utils/tests/data/gcp_util/")
        self.gcp_client.delete_cloud_file
        pass
    
    @responses.activate
    def test_move_file(self):
        responses._add_from_file(file_path="ops_utils/tests/data/gcp_util/")
        self.gcp_client.move_cloud_file
        pass

    @responses.activate
    def test_get_filesize(self):
        responses._add_from_file(file_path="ops_utils/tests/data/gcp_util/")
        self.gcp_client.get_filesize
        pass

    @responses.activate
    def test_check_if_files_are_same(self):
        responses._add_from_file(file_path="ops_utils/tests/data/gcp_util/")
        self.gcp_client.validate_files_are_same()
        pass
